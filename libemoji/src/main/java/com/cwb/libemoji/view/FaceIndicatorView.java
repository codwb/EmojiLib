...
public class FaceIndicatorView extends LinearLayout {
    ...
    public FaceIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private int dip2px(Context mContext, int dp) {
        return (int) (0.5f + dp * mContext.getResources().getDisplayMetrics().density);
    }
